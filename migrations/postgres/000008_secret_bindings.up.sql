...
CREATE TABLE "secret_bindings" (
  ...
  "token_env" varchar(128) NOT NULL,
  "created_at" timestamptz NOT NULL,
  "updated_at" timestamptz NOT NULL,
  PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX IF NOT EXISTS "uidx_secret_bindings_tenant_name" ON "secret_bindings" ("tenant_id","name");

CREATE INDEX IF NOT EXISTS "idx_secret_bindings_tenant" ON "secret_bindings" ("tenant_id");
