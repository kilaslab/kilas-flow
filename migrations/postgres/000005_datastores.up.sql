...
CREATE UNIQUE INDEX IF NOT EXISTS "uidx_datastores_surrogate" ON "datastores" ("surrogate");

CREATE INDEX IF NOT EXISTS "idx_datastores_tenant_name" ON "datastores" ("tenant_id","name");

CREATE TABLE "datastore_columns" (
  "id" bigserial,
  "datastore_id" varchar(64) NOT NULL,
  "name" varchar(255) NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "uidx_datastore_columns_datastore_name" ON "datastore_columns" ("datastore_id","name");

CREATE INDEX IF NOT EXISTS "idx_datastore_columns_datastore" ON "datastore_columns" ("datastore_id");
