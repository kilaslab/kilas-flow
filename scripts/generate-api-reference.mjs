...
const groups = [
	{ slug: 'workflows', title: 'Workflows', blurb: 'Create, read, update, run, activate, and version workflows.', operations: ['create-workflow', 'list-workflows', 'get-workflow', 'update-workflow', 'delete-workflow', 'run-workflow', 'activate-workflow', 'deactivate-workflow', 'list-workflow-versions', 'get-workflow-version', 'publish-workflow-version', 'restore-workflow-version', 'list-workflow-publish-events'] },
