...
3.0](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), the
most widely adopted code of conduct in open source. It applies to every project
space — this repository's issues, pull requests, discussions and commit
messages, and any other place where someone is representing KilasFlow.
...
possible violation, contact the maintainer privately:

- **Email:** yusrilizzaaulia@gmail.com, or
- **GitHub:** [@underworld14](https://github.com/underworld14).

Reports are read only by the maintainer. Please do not open a public issue, and
do not raise it in a thread where the person you are reporting can see it.
...
The remedies and repairs outlined below are Contributor Covenant's suggested
baseline. KilasFlow has no separate enforcement process, so this ladder is the
process.
...
3. **Temporary Suspension**
   ...
   3. *Repair:* Examples of repair include respecting the spirit of the
      ...
      thoughtful about how to reintegrate into the community when the suspension
      is lifted.
4. **Permanent Ban**
...
Covenant](https://www.contributor-covenant.org), version 3.0, permanently
available at
