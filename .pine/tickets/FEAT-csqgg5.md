...
- Reference checkout fixtures: `$KILASFLOW_N8N_REFERENCE/packages/nodes-base/nodes/{HttpRequest,Set,If}/test/**` (25 workflow documents), package licence `LicenseRef-n8n-sustainable-use`.
