...
- Commits (5):
  ...
  - `ad233369` — chore: ignore local kilasflow binary; align s0wy50+xf1wqm testing
  - `f79cb9a3` — BUG-s0wy50: PG-no-vector boot (000006 conditional skip) + live-test guards — migrations
...
```
 ...
 434 files changed, 69695 insertions(+), 4725 deletions(-)
```
